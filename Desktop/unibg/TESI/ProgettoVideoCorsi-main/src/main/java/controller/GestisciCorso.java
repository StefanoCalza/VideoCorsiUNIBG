...
@WebServlet("/GestisciCorso")
public class GestisciCorso extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("/WEB-INF/jsp/gestisci_corso.jsp").forward(request, response);
